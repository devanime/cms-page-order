...
function cmspo_admin_menu() {
	...
	foreach( $post_types as $post_type ) {
		...
		$page = add_submenu_page(
            ...
            apply_filters( 'cmspo_page_label', __( 'Page Order', 'cms-page-order' ), $post_type ),
            apply_filters( 'cmspo_page_label', __( 'Page Order', 'cms-page-order' ), $post_type ),
            apply_filters( 'cmspo_page_capability', 'edit_pages', $post_type),
            'order-' . $post_type,
            'cmspo_menu_order_page'
        );
...
function cmspo_print_scripts() {
	wp_enqueue_script( 'jquery-ui-sortable-1', 'https://cdn.jsdelivr.net/npm/jquery-ui-sortable@1.0.0/jquery-ui.min.js', array('jquery'), false );
	wp_enqueue_script( 'jquery-ui-effects', '', array('jquery', 'jquery-ui'), false );
	wp_enqueue_script( 'jquery-ui-nestedsortable', CMSPO_URL . 'scripts/jquery.ui.nestedSortable-1.3.4.min.js', array('jquery', 'jquery-ui-sortable-1') );
	wp_enqueue_script( 'cms-page-order', CMSPO_URL . 'scripts/cms-page-order.js', array('jquery', 'jquery-ui-sortable-1', 'jquery-ui-nestedsortable'), CMSPO_VERSION );
}
